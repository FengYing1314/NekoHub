...
public class AssetBatchDeleteAndUsageStatsTests : IntegrationTestBase, IClassFixture<NekoHubApiKeyApplicationFactory>
{
    private const string ProtocolVersion = "2025-11-25";

    public AssetBatchDeleteAndUsageStatsTests(NekoHubApiKeyApplicationFactory factory) : base(factory)
    {
