...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.Configure<BootstrapSuperAdminOptions>(configuration.GetSection(BootstrapSuperAdminOptions.SectionName));
        ...
        services.AddScoped<ExifStripAssetPostProcessor>();
        services.AddScoped<FormatConvertAssetPostProcessor>();
        services.AddScoped<WatermarkAssetPostProcessor>();
        ...
        services.AddScoped<ISkillStepExecutor, ExifStripSkillStep>();
        services.AddScoped<ISkillStepExecutor, FormatConvertSkillStep>();
        services.AddScoped<ISkillStepExecutor, WatermarkSkillStep>();
        ...
        services.AddScoped<IWorkflowProfileRepository, EfCoreWorkflowProfileRepository>();
        services.AddScoped<IUserRepository, EfCoreUserRepository>();
        services.AddScoped<IRefreshTokenRepository, EfCoreRefreshTokenRepository>();
        services.AddScoped<IUserPermissionGrantRepository, EfCoreUserPermissionGrantRepository>();
