...
namespace NekoHub.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260907234040_AddDurableAssetJobs")]
    partial class AddDurableAssetJobs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NekoHub.Domain.Ai.AiProviderProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("NekoHub.Domain.Assets.AssetProcessingJob", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AssetProcessingJobs", (string)null);
                });
            ...
            modelBuilder.Entity("NekoHub.Domain.Users.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("NekoHub.Domain.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("NekoHub.Domain.Users.UserPermissionGrant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("NekoHub.Domain.Workflows.WorkflowProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("NekoHub.Domain.Users.RefreshToken", b =>
                {
                    b.HasOne("NekoHub.Domain.Users.User", "User")
