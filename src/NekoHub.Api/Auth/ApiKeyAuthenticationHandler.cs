    ...
    private static ClaimsPrincipal BuildPrincipal(string providedApiKey)
    {
        ...
        var identity = new ClaimsIdentity(
            [
                ...
                new Claim(ApiKeyAuthenticationDefaults.FingerprintClaimType, keyFingerprint),
                new Claim(ApiKeyAuthenticationDefaults.PrincipalTypeClaimType, ApiKeyAuthenticationDefaults.ApiKeyPrincipalType)
            ],
