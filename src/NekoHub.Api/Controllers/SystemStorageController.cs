...
{
    [HttpGet("providers")]
    [Authorize(Policy = PermissionCatalog.ProvidersRead)]
    ...
    [HttpPost("providers")]
    [Authorize(Policy = PermissionCatalog.ProvidersCreate)]
    ...
    [Authorize(Policy = PermissionCatalog.ProvidersUpdate)]
    ...
    [Authorize(Policy = PermissionCatalog.ProvidersDelete)]
