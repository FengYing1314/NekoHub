...
export function isAssetPending(status: AssetStatusLike): boolean {
  return normalizeAssetStatus(status) === 'pending';
}
...
export interface AssetListItemResponse {
  ...
  storageProviderProfileId: string | null;
...
export interface UploadAssetInput {
  ...
  altText?: string;
  isPublic?: boolean;
  storageProviderProfileId?: string;
